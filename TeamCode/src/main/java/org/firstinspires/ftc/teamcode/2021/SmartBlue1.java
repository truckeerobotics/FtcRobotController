...
//
//    // Claw constant (s)
//    private final double maxClawServo = 0.2;
//    private final double minClawServo = 0.75;
//
...
////            telemetry.addData("Passed 1 Second", "No Successful Level Results Yet");
////            telemetry.update();
////        }
//
//        if (isStopRequested()) {
...
//            telemetry.addData("Level Result (So Far):", pipeline.getLevel());
//            telemetry.update();
//            if (isStopRequested()) {
//                return;
//            }
...
//
//        // Raise up arm
//        double levelHeightSetter = 17; //15.85 top level (level 2)
//        double levelDistanceSetter = 4; //3 top level (level 2)
//
//        if (level == 0) {
//            levelHeightSetter = 4;
...
//        }
//        executor.shutdown();
//        moveForward(0.2,8 + levelDistance);
//        moveClaws(false, 1000);
//
//        // Move it back and prepare for next step
//        moveForward(0.3, -10 - levelDistance);
//        setArm(1, 6,0);
//
//
//        // Go to ducks
...
////          Disable arm extension
////            motorDistance.setPower(Math.abs(speed)/2);
//
//            while (opModeIsActive()  && (motorHeight.isBusy())) {
...
//        Scalar max = new Scalar(170,255,170,255);
...
//        }
//        telemetry.update();
//        failedDelayRemaining = delayDefault;
//

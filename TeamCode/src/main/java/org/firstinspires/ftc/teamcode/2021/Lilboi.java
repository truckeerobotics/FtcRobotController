...
//
//    // Grabber/intake
//    private final double maxIntake = 0.2;
//    private final double minIntake = 0.75;
...
//            if (Math.abs(gamepad2.right_stick_y) > Math.abs(gamepad2.left_stick_y)) {
//                heightPower = gamepad2.right_stick_y * -1.1;
//            } else {
//                heightPower = gamepad2.left_stick_y * -1.1;
//            }
//
//
//            // Open intake on push of X on controller 2
//            if(onPush(gamepad2.b, "controller2ButtonX")){
//                intakePower = maxIntake;
//            }
//
//            // Close intake on push of B on controller 2
//            if(onPush(gamepad2.x, "controller2ButtonB")) {
